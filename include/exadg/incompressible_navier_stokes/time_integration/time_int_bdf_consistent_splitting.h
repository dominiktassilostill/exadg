...
#ifndef EXADG_INCOMPRESSIBLE_NAVIER_STOKES_TIME_INTEGRATION_TIME_INT_BDF_CONSISTENT_SPLITTING_H_
#define EXADG_INCOMPRESSIBLE_NAVIER_STOKES_TIME_INTEGRATION_TIME_INT_BDF_CONSISTENT_SPLITTING_H_
...
template<int dim, typename Number>
class TimeIntBDFConsistentSplitting : public TimeIntBDF<dim, Number>
{
private:
...
public:
  TimeIntBDFConsistentSplitting(std::shared_ptr<Operator>                       operator_in,
  ...
  virtual ~TimeIntBDFConsistentSplitting()
  {
  }
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_TIME_INTEGRATION_TIME_INT_BDF_Consistent_SPLITTING_H_ \
        */
